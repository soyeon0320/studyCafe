...
<div>
	<header class="navbar page-header navbar-expand-lg">
       <ul class="nav flex-row mr-auto">
           ...
           <li class="nav-item">												
           		<a href="<%=request.getContextPath() %>/equip/tablet" class="btn btn-icon btn-rounded btn-xl btn-light mb-2">
...
<!-- 	</div> -->
		...
		<div class="row" style="margin: auto;">
			...
			<div class="col-4 mb-20">
				<div class="list bg-success shadow-sm rounded overflow-hidden">
				    <div class="list-item" style="background-color: #3471b4">
			        	...
			        	<input type="hidden" id="equip4" name="equipTotalPrice" value="4000">
				        <input type="hidden" name="equipTicket" value="1시간 이용권">
				       	<input type="hidden" name="equipRentOut" value="1"> 
				            ...
				            <span class="list-title fs-3x  lineH-1">4,000</span>원
				        </div>
				    </div>
				</div>
			</div>
			<div class="col-4 mb-20">
				<div class="list bg-success shadow-sm rounded overflow-hidden">
				    <div class="list-item" style="background-color: #3471b4">
				        <div class="list-body text-center" onclick="rentSelect(this);">
				            <input type="hidden" name="equipTotalPrice" value="7000">
				            ...
				            <span class="list-title fs-2x  lineH-1" ></span>
				            <span class="list-title fs-3x  lineH-1" >7,000</span>원
				        </div>
				    </div>
				</div>
			</div>
			<div class="col-4 mb-20">
				<div class="list bg-success shadow-sm rounded overflow-hidden">
				    <div class="list-item" style="background-color: #3471b4">
				        <div class="list-body text-center" onclick="rentSelect(this);">
				        	<input type="hidden" name="equipTotalPrice" value="11000">
				            ...
				            <span class="list-title fs-2x  lineH-1" ></span>
				            <span class="list-title fs-3x  lineH-1" >11,000</span>원
				        </div>
				    </div>
				</div>
			</div>
			...
			<div class="col-4 mb-20">
				<div class="list bg-success shadow-sm rounded overflow-hidden">
				    <div class="list-item" style="background-color: #3471b4">
				        <div class="list-body text-center" onclick="rentSelect(this);">
				            <input type="hidden" name="equipTotalPrice" value="18000">
				            ...
				            <span class="list-title fs-2x  lineH-1" ></span>
				            <span class="list-title fs-3x  lineH-1" >18,000 </span>원
			...
			<div class="col-4 mb-20">
				<div class="list bg-success shadow-sm rounded overflow-hidden">
				    <div class="list-item" style="background-color: #3471b4">
				        ...
				        <div class="list-body text-center" onclick="rentSelect(this);">
				            <input type="hidden" name="equipTotalPrice" value="22000">
				            ...
				            <span class="list-title fs-2x  lineH-1"></span>
				            <span class="list-title fs-3x  lineH-1">22,000</span>원
	...
	<div id="preparePay" style="display: none; text-align: center;">
		...
		<div class="offset-2 col-8">
			...
			<div align="center" style="margin-top: 30px;">
				...
				<button type="button" style="color: black; background-color:#fee500;" class="btn  btn-icon btn-icon-right btn-rounded btn-xl btn-warning" onclick="rentEquip();">
	...
	<div align="center" style="margin-top: 30px;">
		<iframe id="tabletPay" style="display: none; width: 60%; height: 500px;border-style: hidden;">
		</iframe>
	</div>	
</div>
...
// 	var equipTicket = $('#ticketName').text();
// 	var equipName = $('input[name=equipName]').val();
	
// 	sessionStorage.setItem("equipTotalPrice", $('#ticketPrice').text());
// 	sessionStorage.setItem("equipTicket", $('#ticketName').text());
// 	sessionStorage.setItem("equipName", $('input[name=equipName]').val());
	
// 	localStoarage.clear();
// 	kakaoSend(qrInfo, serverIp);
...
function kakaoSend(qrInfo, serverIp){
	var equipTotalPrice = $('#ticketPrice').text();
...
// 	localStorage.setItem("equipTotalPrice", $('#ticketPrice').text());
// 	localStorage.setItem("equipTicket", $('#ticketName').text());
// 	localStorage.setItem("equipName", $('input[name=equipName]').val());
	
	localStorage.clear();
	$.ajax({
	    url : "<%=request.getContextPath()%>/equip/send", 
	    type : 'POST', 
	    data : {equipTotalPrice : equipTotalPrice,
			   memId : memId, equipCode : equipCode, equipName : equipName,
			   rentOut : rentOut, equipTicket : equipTicket, qrInfo : qrInfo}, 
	    success : function(data) {
	    	console.log("데이터???"+data);
	    	sendTo(qrInfo, serverIp, data.kakaoSend.equipTicket, data.kakaoSend.equipTotalPrice, data.kakaoSend.equipName);
              ...
              buttons: [
                {
                  title: '큐알코드확인하기',
                  link: {
                    mobile_web_url: 'http://'+serverIp+'/scm/qrImage/'+qrInfo+'.png',
